...
//    private ArrayList<Personaje> orden = new ArrayList<>();
    ...
    public Combate(Monstruo m, Party p, JuegoDado jd, InventarioObjeto io) {
        aliados = p;
        enemigo = m;
        dado = jd;
        inventObj = io;
...
//    }
    public void combate() {
        ...
        if (hpMonstruo > 0) {
            System.out.println("todos tus luchadores han sido derrotados");
            mensaje="todos tus luchadores han sido derrotados";
        } else {
            System.out.println("El enemigo a muerto, se agregara un Item a tu inventario");
            ...
            inventObj.mostrarInventario();
            mensaje="El enemigo a muerto, se agregara un Item a tu inventario";
        }
    }
